 ...
 * <p>
 * This service provides automated periodic execution of maintenance tasks such as
 * checking for overdue loans and triggering user notifications. It uses Java's
 * built-in {@link Timer} mechanism to schedule tasks at fixed intervals.
 * </p>
 * <p>
 * The scheduler runs as a daemon thread, which means it will not prevent the JVM
...
public class SchedulerService {
     ...
     * </p>
     * <p>
     * The first execution occurs one minute after this method is called,
     * followed by subsequent executions every 24 hours.
     * </p>
     *
     ...
     * @param periodMs the interval between successive executions in milliseconds
    ...
    public void startOverdueCheckScheduler(long initialDelayMs, long periodMs) {
        ...
        logger.logSchedulerStart(String.format(
				"Overdue loan checker scheduled to run every %d ms after an initial delay of %d ms",
     ...
     * <p>
     * After calling this method, no further scheduled tasks will execute.
     * To restart scheduling, call {@link #startOverdueCheckScheduler()} again.
     * </p>
     * <p>
