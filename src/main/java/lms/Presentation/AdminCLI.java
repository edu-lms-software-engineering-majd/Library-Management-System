...
/**
 * Command-Line Interface (CLI) for administrator operations in the
 * Library Management System.
 *
 * <p>
 * Provides a text-based interface that allows administrators to perform
 * CRUD (Create, Read, Update, Delete) operations on both books and users.
 * The admin can also view reports and manage system resources.
 * </p>
 *
 * <h2>Main Responsibilities:</h2>
 * <ul>
 *   <li>Display a menu of administrative options</li>
 *   <li>Interact with {@link BookService} and {@link UserService} to perform operations</li>
...
//	        Book book = new Book(title, author, isbn, publisher, year, category, totalCopies, language, description, shelfLocation);
	...
	private void handleUpdateUser() {
		...
		try {
			...
			boolean updated = userService.updateUser(AuthService.getCurrentUser(), existing.userID(), newUsername, password, email, role);
