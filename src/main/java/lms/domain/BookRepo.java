 ...
 *
 * <p>This defines the contract for book persistence and retrieval operations,
 * without specifying the storage mechanism. Implementations may use in-memory
 * storage, relational databases, or any other persistence strategy.</p>
 *
 * <p>Following the Repository pattern, this interface abstracts access to the
...
public interface BookRepo {
     ...
     * @return {@code true} if the book was added, {@code false} if it already exists
     */
     ...
     * @return {@code true} if deletion was successful, {@code false} if book not found
     */
