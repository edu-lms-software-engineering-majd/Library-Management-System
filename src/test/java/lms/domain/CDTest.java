...
class CDTest {
	...
	void shouldThrowExceptionWhenTitleIsEmpty() {
		assertThrows(IllegalArgumentException.class, () -> new CD("", "Artist"));
	}
	...
	void shouldThrowExceptionWhenArtistIsEmpty() {
		assertThrows(IllegalArgumentException.class, () -> new CD("Title", ""));
	}
	...
	void shouldThrowExceptionWhenTotalCopiesIsZero() {
		assertThrows(IllegalArgumentException.class, () -> new CD("Title", "Artist", 0));
	}

	@Test
	void shouldThrowExceptionWhenTotalCopiesIsNegative() {
		assertThrows(IllegalArgumentException.class, () -> new CD("Title", "Artist", -1));
	}
	...
	void shouldThrowExceptionWhenSettingNegativeTotalCopies() {
		assertThrows(IllegalArgumentException.class, () -> cd.setTotalCopies(-1));
	}
	...
	void shouldThrowExceptionWhenSettingNegativeAvailableCopies() {
		assertThrows(IllegalArgumentException.class, () -> cd.setAvailableCopies(-1));
	}

	@Test
	void shouldThrowExceptionWhenSettingAvailableCopiesBeyondTotal() {
		assertThrows(IllegalArgumentException.class, () -> cd.setAvailableCopies(5));
	}
